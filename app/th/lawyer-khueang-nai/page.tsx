...
const title = 'ทนายความเขื่องใน ปรึกษาฟรี รับว่าความทั่วราชอาณาจักร | สำนักกฎหมายเที่ยงธรรม (19+ ปี)'

const description =
  'ทนายความเขื่องใน สำนักกฎหมายเที่ยงธรรมทนายความ ประสบการณ์กว่า 19 ปี ให้บริการปรึกษากฎหมายเบื้องต้นฟรี รับว่าความคดีแพ่ง คดีอาญา คดีครอบครัว คดีมรดก คดีที่ดิน ในอำเภอเขื่องใน อุบลราชธานี และทั่วราชอาณาจักร'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${baseUrl}/th/lawyer-khueang-nai`,
  },
  openGraph: {
    title,
    description,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ทนายความเขื่องใน สำนักกฎหมายเที่ยงธรรมทนายความ',
      },
    ],
  },
  twitter: {
...
export default function LawyerKhueangNaiPage() {
  ...
  return (
    <main id="main-content" className="overflow-x-hidden selection:bg-gold/30">
      ...
      <PageHero
        title="ทนายความเขื่องใน"
        description="สำนักกฎหมายเที่ยงธรรมทนายความ ประสบการณ์กว่า 19 ปี ให้บริการปรึกษากฎหมายเบื้องต้นฟรี ตรวจข้อเท็จจริง และประเมินแนวทางคดีแก่ประชาชนในอำเภอเขื่องใน พร้อมรับว่าความทั่วราชอาณาจักร"
        crumbs={[{ href: '/th', label: 'หน้าแรก' }, { label: 'ทนายความเขื่องใน' }]}
      />
        ...
        <Container>
          <div className="max-w-3xl">
            <p className="text-base leading-8 text-muted-foreground md:text-lg">
              อำเภอเขื่องในอยู่ทางตอนบนของจังหวัดอุบลราชธานี ไม่ไกลจากตัวเมืองและศาลจังหวัดอุบลราชธานี สำนักงานของเราพร้อมดูแลลูกความในเขื่องใน ทั้งการปรึกษาออนไลน์ การนัดหมาย และการดำเนินคดีที่ศาลจังหวัดและศาลแขวงอุบลราชธานี โดยทีมทนายประสบการณ์กว่า 19 ปี
            </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <h2 className="mt-3 font-serif text-3xl font-bold text-primary">
                ปรึกษาทนายในพื้นที่เขื่องในและอุบลราชธานี
              </h2>
              <p className="mt-5 text-base leading-8 text-muted-foreground">
                หากคุณอยู่ในอำเภอเขื่องในหรือพื้นที่ใกล้เคียง และต้องการปรึกษาทนายความเกี่ยวกับคดีแพ่ง คดีอาญา คดีครอบครัว
      ...
      <section className="bg-secondary/25 py-16 md:py-20">
        <Container>
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-base leading-8 text-muted-foreground">
              ภาพรวมหมวดงานที่ผู้ติดต่อในพื้นที่เขื่องในและอุบลราชธานีมักสอบถามสำนักงาน
            </p>
          </div>
        ...
        <Container>
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            <div className="rounded-3xl border border-gold/25 bg-card p-6 md:p-8">
              <p className="text-sm font-bold uppercase tracking-[0.16em] text-gold-ink">
                Khueang Nai / Ubon Ratchathani
              </p>
              <h2 className="mt-3 font-serif text-3xl font-bold text-primary">
                ต้องการหาทนายใกล้ฉันในเขื่องใน?
              </h2>
              <p className="mt-5 text-base leading-8 text-muted-foreground">
      ...
      <CTASection
        title="ต้องการปรึกษาทนายความในพื้นที่เขื่องใน?"
